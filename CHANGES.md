...
### Added
- Python 3.15 support: trove classifier, wheels for CPython 3.15 and tests on
  Python 3.15 in CI.
...
Supersedes 1.0.1, which was only partially uploaded to PyPI (Python 3.10
wheels with Apache license metadata) and was removed.
